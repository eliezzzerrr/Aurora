...
#property version   "1.73"   // file is SRLevels_EA_v1.7.3 - bump both together
   ...
   switch(TrendMode)
     {
      ...
      case TREND_EMA_ONLY:     return(StringFormat("close vs EMA%d", TrendEMAPeriod));
      ...
      switch(TrendMode)
        {
         ...
         case TREND_EMA_ONLY:     dir = (gTClose > gTEma) ? 1 : ((gTClose < gTEma) ? -1 : 0); break;
...
void DrawPanel()
  {
   ...
   PanelRow(row++, "SR LEVELS EA v1.7.3", real ? "REAL MONEY" : "demo", clrGold, real ? clrRed : clrSilver);
