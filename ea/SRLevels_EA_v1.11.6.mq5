...
#property version   "1.116"  // file is SRLevels_EA_v1.11.6 - bump both together
...
void DrawPanel()
  {
   ...
   PanelRow(row++, "SR LEVELS EA v1.11.6", real ? "REAL MONEY" : "demo", clrGold, real ? clrRed : clrSilver);
