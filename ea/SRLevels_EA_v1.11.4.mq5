...
#property version   "1.114"  // file is SRLevels_EA_v1.11.4 - bump both together
...
void DrawPanel()
  {
   ...
   PanelRow(row++, "SR LEVELS EA v1.11.4", real ? "REAL MONEY" : "demo", clrGold, real ? clrRed : clrSilver);
