...
#property version   "3.00"   // file is TrendEMA_EA_v3 - bump both together
...
int OnInit()
  {
   ...
   if(EnableRsiExtreme)
      PrintFormat("[TREMA] RSI EXTREME: ENABLED  BUY %.0f/%.0f (3TF %.0f)  "
                  "SELL %.0f/%.0f (3TF %.0f)  entry=%s  reset=%.0f  "
                  "SL=%.0fp TP=%.0fp  cancels-trend=%s",
                  RsiXFastLevel, RsiXSlowLevel, RsiX3TFLevel,
                  100.0 - RsiXFastLevel, 100.0 - RsiXSlowLevel, 100.0 - RsiX3TFLevel,
