...
#property version   "1.115"  // file is SRLevels_EA_v1.11.5 - bump both together
...
input int    MaxTradesPerDay    = 5;     // Max fills per trading day (0 = unlimited)
...
void DrawPanel()
  {
   ...
   PanelRow(row++, "SR LEVELS EA v1.11.5", real ? "REAL MONEY" : "demo", clrGold, real ? clrRed : clrSilver);
