...
#property version   "1.80"   // file is SRLevels_EA_v1.8 - bump both together
...
void DrawPanel()
  {
   ...
   PanelRow(row++, "SR LEVELS EA v1.8", real ? "REAL MONEY" : "demo", clrGold, real ? clrRed : clrSilver);
