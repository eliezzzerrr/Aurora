...
#property version   "1.60"   // file is SRLevels_EA_v1.6 - bump both together
...
void DrawPanel()
  {
   ...
   PanelRow(row++, "SR LEVELS EA v1.6", real ? "REAL MONEY" : "demo", clrGold, real ? clrRed : clrSilver);
