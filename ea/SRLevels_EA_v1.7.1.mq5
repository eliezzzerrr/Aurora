...
#property version   "1.71"   // file is SRLevels_EA_v1.7.1 - bump both together
...
void DrawPanel()
  {
   ...
   PanelRow(row++, "SR LEVELS EA v1.7.1", real ? "REAL MONEY" : "demo", clrGold, real ? clrRed : clrSilver);
