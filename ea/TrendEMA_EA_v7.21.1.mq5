...
#property version   "7.211"  // file is TrendEMA_EA_v7.21.1 - bump both together
...
input double TakeProfitTrendPips    = 1500; // TP with-trend (1500 pips)
