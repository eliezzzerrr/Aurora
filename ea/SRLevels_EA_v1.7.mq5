...
#property version   "1.70"   // file is SRLevels_EA_v1.7 - bump both together
...
void DrawPanel()
  {
   ...
   PanelRow(row++, "SR LEVELS EA v1.7", real ? "REAL MONEY" : "demo", clrGold, real ? clrRed : clrSilver);
