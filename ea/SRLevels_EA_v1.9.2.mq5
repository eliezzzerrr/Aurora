...
#property version   "1.92"   // file is SRLevels_EA_v1.9.2 - bump both together
...
void DrawPanel()
  {
   ...
   PanelRow(row++, "SR LEVELS EA v1.9.2", real ? "REAL MONEY" : "demo", clrGold, real ? clrRed : clrSilver);
