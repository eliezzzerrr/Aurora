...
#property version   "7.37"   // file is TrendEMA_EA_v7.37 - bump both together
...
//
//    NOTE this input governs the LIMIT cascade only. The 15M CROSS branch in
//    EvaluateCross has no input gate, so XING @ 15M (29 trades, -13.1R)
//    survives this change. Left alone on purpose: one variable at a time,
//    and 29 trades over 21 months does not justify a code change yet.
input bool   UseFallback15M     = false; // Fall back again to the 15M EMA50 when the 5M level is unplaceable
