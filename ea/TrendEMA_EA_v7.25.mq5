...
#property version   "7.25"   // file is TrendEMA_EA_v7.25 - bump both together
...
input int    MaxSameDirLosses       = 3;    // Block a direction after this many losses in a row in it (0 = off)
...
void FireRsiExtreme()
  {
   ...
   if(ok)
     {
      RememberGeometry(gTrade.ResultOrder(), RsiXStopLossPips, tpPips);
...
void FireTrendRsi()
  {
   ...
   if(ok)
     {
      RememberGeometry(gTrade.ResultOrder(), TrendRsiSLPips, TrendRsiTPPips);
