...
#property version   "1.00"   // file is SRLevels_EA_v1.0 - bump both together
...
void DrawPanel()
  {
   ...
   PanelRow(row++, "SR LEVELS EA v1.0", real ? "REAL MONEY" : "demo", clrGold, real ? clrRed : clrSilver);
