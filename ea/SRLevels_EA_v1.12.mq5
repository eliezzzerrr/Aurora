...
#property version   "1.120"  // file is SRLevels_EA_v1.12 - bump both together
...
void DrawPanel()
  {
   ...
   PanelRow(row++, "SR LEVELS EA v1.12", real ? "REAL MONEY" : "demo", clrGold, real ? clrRed : clrSilver);
