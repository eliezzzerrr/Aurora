...
#property version   "1.91"   // file is SRLevels_EA_v1.9.1 - bump both together
...
void DrawPanel()
  {
   ...
   PanelRow(row++, "SR LEVELS EA v1.9.1", real ? "REAL MONEY" : "demo", clrGold, real ? clrRed : clrSilver);
