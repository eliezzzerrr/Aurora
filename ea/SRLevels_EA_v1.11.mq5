...
#property version   "1.110"  // file is SRLevels_EA_v1.11 - bump both together
...
void DrawPanel()
  {
   ...
   PanelRow(row++, "SR LEVELS EA v1.11", real ? "REAL MONEY" : "demo", clrGold, real ? clrRed : clrSilver);
