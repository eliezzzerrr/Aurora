...
#property version   "7.16"   // file is TrendEMA_EA_v7.16 - bump both together
...
bool EvaluateCross(const int dir, const bool deepOnly = false)
  {
   double bid      = SymbolInfoDouble(_Symbol, SYMBOL_BID);
