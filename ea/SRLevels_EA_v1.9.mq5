...
#property version   "1.90"   // file is SRLevels_EA_v1.9 - bump both together
...
void DrawPanel()
  {
   ...
   PanelRow(row++, "SR LEVELS EA v1.9", real ? "REAL MONEY" : "demo", clrGold, real ? clrRed : clrSilver);
   ...
   PanelRow(row++, "4H VALUES", StringFormat("close %.2f  EMA%d %.2f  MA50 %.2f  cloud %.2f/%.2f", gTClose,
