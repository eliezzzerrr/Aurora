...
#property version   "1.40"   // file is SRLevels_EA_v1.4 - bump both together
...
void DrawPanel()
  {
   ...
   PanelRow(row++, "SR LEVELS EA v1.4", real ? "REAL MONEY" : "demo", clrGold, real ? clrRed : clrSilver);
