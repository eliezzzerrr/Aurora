...
#property version   "1.130"  // file is SRLevels_EA_v1.13 - bump both together
...
void DrawPanel()
  {
   ...
   PanelRow(row++, "SR LEVELS EA v1.13", real ? "REAL MONEY" : "demo", clrGold, real ? clrRed : clrSilver);
