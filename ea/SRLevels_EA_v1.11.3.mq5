...
#property version   "1.113"  // file is SRLevels_EA_v1.11.3 - bump both together
...
void DrawPanel()
  {
   ...
   PanelRow(row++, "SR LEVELS EA v1.11.3", real ? "REAL MONEY" : "demo", clrGold, real ? clrRed : clrSilver);
